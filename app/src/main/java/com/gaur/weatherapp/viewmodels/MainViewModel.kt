...
import com.gaur.weatherapp.activities.CurrentCondition
...
@HiltViewModel
class MainViewModel @Inject constructor(private val currentCondition: CurrentCondition) :
    ViewModel() {
    ...
    fun getCurrentWeather(lat: Double, long: Double) = viewModelScope.launch {
        ...
        try {
            ...
            val response = currentCondition.getCurrentLocationWeather(lat, long)
