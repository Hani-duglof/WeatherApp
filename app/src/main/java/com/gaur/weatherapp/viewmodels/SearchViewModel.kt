...
import com.gaur.weatherapp.activities.Search
...
@HiltViewModel
class SearchViewModel @Inject constructor(private val search: Search) :
    ViewModel() {
    ...
    fun getWeather(zipCode: String) = viewModelScope.launch {
        ...
        try {
            ...
            val response = search.getWeather(zipCode = zipCode)
